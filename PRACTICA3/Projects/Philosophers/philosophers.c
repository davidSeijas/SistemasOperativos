...
{
    int nPhilosopher = (int)i; //numero de filosofo
    int right = nPhilosopher; //numero palillo derecho del filosofo
    int left = (nPhilosopher - 1 == -1) ? NR_PHILOSOPHERS - 1 : (nPhilosopher - 1); //numero palillo izquierdo del filosofo
